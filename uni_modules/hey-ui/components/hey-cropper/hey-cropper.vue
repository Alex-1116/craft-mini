<template>
	<view class="hey-cropper-container" :style="[containerStyle]">
		...
		<!-- #endif -->
			<template v-if="imageRect && cropperRect">
				<!-- #ifdef APP-VUE || MP-WEIXIN || MP-QQ || H5 -->
				<image mode="aspectFit" :src="imageSrc" class="image" :rotateAngle="rotateAngle" :change:imageRect="wxsModule.changeImageRect" :change:rotateAngle="wxsModule.changeRotateAngle" :imageRect="imageRect" :class="{ anim }">
				<!-- #endif -->
				<!-- #ifndef APP-VUE || MP-WEIXIN || MP-QQ || H5 -->
...
<script>
// #ifndef APP-VUE || MP-WEIXIN || MP-QQ || H5
import touches from './libs/touchs.js';
// #endif
