...
> - 如使用过程中有任何问题，或者您有一些好的建议，欢迎联系作者微信:four_this
...
<template>
	<view class="container">
		<hey-cropper ref="cropper" :imageSrc="imageSrc"></hey-cropper>
...
hey-cropper，指定ratio即可设置裁切框的宽高比，如果你想让用户自由缩放，将ratio设置为0即可

**示例**

```html
<hey-cropper ref="cropper" :ratio="16/9":imageSrc="imageSrc"></hey-cropper>
```
